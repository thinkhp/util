...
func SendGet(url string, headersMap map[string]string) ([]byte, error) {
	return Send(http.MethodGet, url, headersMap, nil)
}
func SendPost(url string, headersMap map[string]string, params []byte) ([]byte, error) {
	return Send(http.MethodPost, url, headersMap, params)
}
//e.g.
...
func Send(method string, url string, headersMap map[string]string, params []byte) ([]byte, error) {
